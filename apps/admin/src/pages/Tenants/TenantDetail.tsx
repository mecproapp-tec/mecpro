          ...
          <div className="flex items-center gap-4">
            {tenant.logoUrl ? (
              <img
                src={tenant.logoUrl}
                alt="Logo"
                className="w-16 h-16 rounded-full object-cover border-2 border-neonBlue"
              />
            ) : (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white">
                  {tenant.documentNumber} ({tenant.documentType || 'CNPJ/CPF'})
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
          ...
          {estimates.map((est) => (
            <tr key={est.id} className="border-t border-gray800">
              ...
              <td className="p-3 text-right text-gray-300">
                R$ {!isNaN(est.total) ? est.total.toFixed(2) : '0,00'}
              </td>
              <td className="p-3">
        ...
        <tbody>
          {invoices.map((inv) => (
            <tr key={inv.id} className="border-t border-gray800">
              ...
              <td className="p-3 text-right text-gray-300">
                R$ {!isNaN(inv.total) ? inv.total.toFixed(2) : '0,00'}
              </td>
              <td className="p-3">
                <span className="px-2 py-1 rounded-full text-xs bg-gray700 text-white">
                  {inv.status}
