...
export class EmailService {
  ...
  async sendRegistrationEmail(email: string, token: string, officeName: string): Promise<void> {
  ...
  async sendSubscriptionCanceledEmail(email: string, name: string): Promise<void> {
    const html = `
      <!DOCTYPE html>
      <html>
      <head>
