...
import toast from "react-hot-toast"; // ← nome correto: "react-hot-toast"
...
export default function OficinaConfig() {
  ...
  console.log("Estado após setOficina:", oficina);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await fetchData(); // recarrega os dados atualizados
    } catch (error: any) {
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
              <div>
                <label style={{ color: "#a0a0a0", display: "block", marginBottom: "8px" }}>Número</label>
                <input
                  type="text"
                  name="numero"
              ...
              <div>
                <label style={{ color: "#a0a0a0", display: "block", marginBottom: "8px" }}>Complemento</label>
                <input
                  type="text"
                  name="complemento"
                  value={oficina.complemento}
                  onChange={handleChange}
