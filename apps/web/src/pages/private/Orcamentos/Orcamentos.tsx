        ...
        >
          {[
            ...
            <button
              ...
              onMouseEnter={(e) => {
                if (filtro !== f.key) e.currentTarget.style.background = "#00e5ff10";
              }}
              onMouseLeave={(e) => {
                if (filtro !== f.key) e.currentTarget.style.background = "transparent";
              }}
            >
              {f.label}
            </button>
            ...
            >
              <thead>
                <tr style={{ background: "#1e1e1e", borderBottom: "2px solid #00e5ff30" }}>
                  ...
                  <th style={{ padding: "20px 16px", textAlign: "right", fontWeight: "600", color: "#a0a0a0" }}>
                    Total (R$)
                  </th>
                  <th style={{ padding: "20px 16px", textAlign: "left", fontWeight: "600", color: "#a0a0a0" }}>
                    Status
                  </th>
                  <th style={{ padding: "20px 16px", textAlign: "center", fontWeight: "600", color: "#a0a0a0" }}>
                    Ações
                  </th>
                </tr>
              </thead>
                          ...
                          {o.status === "converted" ? (
                            ...
                            <>
                              ...
                              <button
                                ...
                                onMouseEnter={(e) => {
                                  e.currentTarget.style.background = "#ffcc0020";
                                  e.currentTarget.style.borderColor = "#ffcc00";
                                }}
                                onMouseLeave={(e) => {
                                  e.currentTarget.style.background = "#1a1a1a";
                                  e.currentTarget.style.borderColor = "#ffcc0030";
                                }}
